...
<body>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <h1 class="title is-5 has-text-centered mt-5 mb-4">Are you sure you want to delete this Scientist?</h1>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        confirmBtn.addEventListener('click', function () {
            if (deleteId !== null) {
                window.location.href = "<?= base_url('institution/balik_scientist/delete/') ?>" + deleteId;
            }
        });
