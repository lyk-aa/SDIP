...
<style>
    ...
    .input:focus, .select select:focus, textarea.textarea:focus {
        border-color: #3273dc;
...
<div class="modal is-active" id="main-modal">
    ...
    <div class="modal-card">
        ...
        <section class="modal-card-body">
            <form id="balik-scientist-form" action="<?= site_url('/institution/balik_scientist/store') ?>" method="post" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="image-placeholder" onclick="document.getElementById('image').click()">
                    <figure class="profile-image">
                        ...
                        <img id="profile-preview" src="<?= base_url('uploads/' . ($scientist['image'] ?? 'default.png')) ?>">
                ...
                <div class="field">
                    ...
                    <div class="control" style="display: flex; gap: 20px;">
                        <label class="checkbox">
                            <input type="checkbox" name="dynamic_choice[]" value="Balik Scientist" onclick="generateFields()">
                            Balik Scientist
                        </label>
                        <label class="checkbox">
                ...
                <div class="columns">
                    <div class="column is-half">
                        <div class="field">
                            ...
                            <div class="control select-input-container">
                                <input type="text" id="honorifics" name="honorifics" class="input" placeholder="Or enter manually">
                                <select class="select-overlay" onchange="document.getElementById('honorifics').value=this.value">
                                    <option value=""></option>
                    ...
                    <div class="column is-half">
                        <div class="field">
                            ...
                            <div class="control select-input-container">
                                <input type="text" id="role" name="role" class="input" placeholder="Or enter manually" required>
                                <select class="select-overlay" onchange="document.getElementById('role').value=this.value">
                                    <option value=""></option>
