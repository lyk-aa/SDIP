...
<body>
<!-- Main Modal for Edit Research Center -->
<div class="modal is-active" id="main-modal">
    <div class="modal-background"></div>
    <div class="modal-card">
        <section class="modal-card-body">
            <p class="modal-card-title">Edit Research Center</p>

            <button class="modal-close-btn" id="close-modal" aria-label="close">
                <i class="fas fa-times"></i>
            </button>

            <form id="projects-form" action="<?= site_url('/institution/research_centers/update/' . $research_center->id) ?>"
                                    ...
                                    <select id="institution-select" name="institution" required>
                                        ...
                                        <?php foreach ($institutions as $institution): ?>
                                            <option value="<?= $institution->id ?>"
                                                    <?= ($institution->id == $research_center->institution_id) ? 'selected' : '' ?>
                        ...
                        <div class="field">
                            ...
                            <div class="control">
                                <input type="text" name="name" class="input"
                                       value="<?= old('name', $research_center->name ?? '') ?>" required>
                            </div>
                        </div>
                    </div>
                </div>
